...
;-| Kunai - Shuriken |-----------------------------------------------------
[Command]
name = "kunai" ;nome do comando
command = b ;direção do comando
...
;---------------------------------------------------------------------------
; Hyper Level 5
[State -1, super level 1]
type = changestate
value = 8499
triggerall = command = "HyperUm"
trigger1 = power > 5000
...
type = changestate
value = 333
triggerall = command = "SuperUm"
trigger1 = power > 1000
trigger1 = stateType = S
trigger1 = ctrl

; Super Level 2
[State -1, super level 2]
type = changestate
value = 8550
triggerall = command = "SuperDois"
trigger1 = power > 1000
trigger1 = stateType = S
trigger1 = ctrl
...
;---------------------------------------------------------------------------
; Super Pulo
[State -1, superpulo cima, frente e tras]
type = changestate
...
value = 231 ;numero do State que ele vai
triggerall = Command = "kunai" ;comando do golpe
...
type = ChangeState
value = 200
triggerall = (command = "x" || command = "down_x")
...
type = ChangeState
value = 210
triggerall = (command = "y" || command = "down_y")
;triggerall = command != "holddown"
trigger1 = (statetype = S || statetype = C)
trigger1 = ctrl
...
type = ChangeState
value = 220
triggerall = (command = "z" || command = "down_z")
;triggerall = command != "holddown"
trigger1 = (statetype = S || statetype = C)
Trigger1 = Command != "x"
trigger1 = ctrl
